package com.cherno.rain.entity.particle;
...
public class Particle extends Entity {
	...
	protected double xx, yy, zz; // for more precision
	protected double xa, ya, za; // amount of pixels to move in x & y direction
